...
import ru.erked.spaceflight.game.ResultsScreen;
...
public class UnarScreen implements Screen{
	...
	public UnarScreen(final StartSFlight game){
		this.game = game;
	}
	...
	public void show() {
		...
		backgroundSprite = RES.atlas.createSprite("unar");
		backgroundSprite.setBounds(0.0F, 0.0F, width, 2.0F*height);
		
		if(INF.planetLevel >= 40){
			timer = 60*60;
			...
			rocketTimer = CurPR.getCurRocket().getTimeBonus()*60 + 60;
			gemsToWin = 235 + (INF.planetLevel - CurPR.getCurPlanet().getLevel())*15;
		}
	...
	private void gemInit(){
		...
		for(int i=0;i<5;i++){
			for(int j=0;j<10;j++){
				gemMatrix[i][j] = rand.nextInt(7) + 1;
				...
				case 1:{
					...
					diamond[i][j] = RES.atlas.createSprite("diamond");
					break;
				}case 6:{
					amber[i][j] = RES.atlas.createSprite("amber");
					break;
				}case 7:{
					obsidian[i][j] = RES.atlas.createSprite("obsidian");
					break;
				}case 11:{
					...
					diamond[i][j] = RES.atlas.createSprite("diamondB");
					break;
				}case 25:{
					diamond[i][j] = RES.atlas.createSprite("diamondC");
					break;
				}case 35:{
					diamond[i][j] = RES.atlas.createSprite("diamondL");
					break;
				}case 45:{
					diamond[i][j] = RES.atlas.createSprite("diamondT");
					break;
				}case 16:{
					amber[i][j] = RES.atlas.createSprite("amberB");
					break;
				}case 26:{
					amber[i][j] = RES.atlas.createSprite("amberC");
					break;
				}case 36:{
					amber[i][j] = RES.atlas.createSprite("amberL");
					break;
				}case 46:{
					amber[i][j] = RES.atlas.createSprite("amberT");
					break;
				}case 17:{
					obsidian[i][j] = RES.atlas.createSprite("obsidianB");
					break;
				}case 27:{
					obsidian[i][j] = RES.atlas.createSprite("obsidianC");
					break;
				}case 37:{
					obsidian[i][j] = RES.atlas.createSprite("obsidianL");
					break;
				}case 47:{
					obsidian[i][j] = RES.atlas.createSprite("obsidianT");
					break;
				}case 9:{
					granite[i][j] = RES.atlas.createSprite("granite");
					break;
				}default:{
					break;
				}
	...
	private boolean addition(){
		...
		for(int j=0;j<10;j++){
			if(gemMatrix[0][j] == 0){
				check = true;
				gemMatrix[0][j] = rand.nextInt(7) + 1;
				...
				case 1:{
					...
					diamond[0][j] = RES.atlas.createSprite("diamondB");
					diamond[0][j].setBounds(0.085F*width + j*0.083765F*width, 0.625F*height, 0.07615F*width, 0.07615F*width);
					break;
				}case 25:{
					diamond[0][j] = RES.atlas.createSprite("diamondC");
					diamond[0][j].setBounds(0.085F*width + j*0.083765F*width, 0.625F*height, 0.07615F*width, 0.07615F*width);
					break;
				}case 35:{
					diamond[0][j] = RES.atlas.createSprite("diamondL");
					diamond[0][j].setBounds(0.085F*width + j*0.083765F*width, 0.625F*height, 0.07615F*width, 0.07615F*width);
					break;
				}case 45:{
					diamond[0][j] = RES.atlas.createSprite("diamondT");
					diamond[0][j].setBounds(0.085F*width + j*0.083765F*width, 0.625F*height, 0.07615F*width, 0.07615F*width);
					break;
				}case 16:{
					amber[0][j] = RES.atlas.createSprite("amberB");
					amber[0][j].setBounds(0.085F*width + j*0.083765F*width, 0.625F*height, 0.07615F*width, 0.07615F*width);
					break;
				}case 26:{
					amber[0][j] = RES.atlas.createSprite("amberC");
					amber[0][j].setBounds(0.085F*width + j*0.083765F*width, 0.625F*height, 0.07615F*width, 0.07615F*width);
					break;
				}case 36:{
					amber[0][j] = RES.atlas.createSprite("amberL");
					amber[0][j].setBounds(0.085F*width + j*0.083765F*width, 0.625F*height, 0.07615F*width, 0.07615F*width);
					break;
				}case 46:{
					amber[0][j] = RES.atlas.createSprite("amberT");
					amber[0][j].setBounds(0.085F*width + j*0.083765F*width, 0.625F*height, 0.07615F*width, 0.07615F*width);
					break;
				}case 17:{
					obsidian[0][j] = RES.atlas.createSprite("obsidianB");
					obsidian[0][j].setBounds(0.085F*width + j*0.083765F*width, 0.625F*height, 0.07615F*width, 0.07615F*width);
					break;
				}case 27:{
					obsidian[0][j] = RES.atlas.createSprite("obsidianC");
					obsidian[0][j].setBounds(0.085F*width + j*0.083765F*width, 0.625F*height, 0.07615F*width, 0.07615F*width);
					break;
				}case 37:{
					obsidian[0][j] = RES.atlas.createSprite("obsidianL");
					obsidian[0][j].setBounds(0.085F*width + j*0.083765F*width, 0.625F*height, 0.07615F*width, 0.07615F*width);
					break;
				}case 47:{
					obsidian[0][j] = RES.atlas.createSprite("obsidianT");
					obsidian[0][j].setBounds(0.085F*width + j*0.083765F*width, 0.625F*height, 0.07615F*width, 0.07615F*width);
					break;
				}default:{
					break;
	...
	private void buttonListener(){
		...
		if(isGameOver){
			if(controller.isClickedCam(back.getX(camera, width), back.getY(camera, height), back.getWidth(), back.getHeight(), true, camera, 1.0F)){
				game.setScreen(new ResultsScreen(game, gemsToWin, score, timeLeft, isVictory, isEndlessMode));
				this.dispose();
			}
		}
	}
